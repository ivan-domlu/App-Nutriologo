...
import { View, Text, KeyboardAvoidingView, TextInput, Platform, TouchableOpacity } from 'react-native';
...
const RegistroNutriologoScreen = ({ navigation }) => {
    ...
    return (                    
        ...
        >     
            ...
            <Text style={[styles.title, { fontSize: 24, marginBottom: 40 }]}>Cambiando vidas</Text>            
            ...
            />
            <Text style={styles.labelRegister}>Título *</Text>
            <ButtonLargeSecondary style={{ marginBottom: 40 }}>Adjuntar documento</ButtonLargeSecondary>
